...
public class MainActivity4 extends AppCompatActivity implements View.OnClickListener{
    ...
    private Question[] questionBank = new Question[] {
            ...
            new Question(R.string.a2, "Information Security"),
            new Question(R.string.b2, "Threat"),
            new Question(R.string.c2, "ignored"),
            new Question(R.string.d2, "Vulnerability"),
            new Question(R.string.e2, "Encryption"),
            new Question(R.string.f2, "Hacking"),
            new Question(R.string.g2, "To protect your computer from all known viruses."),
            new Question(R.string.h2, "Hacking"),
            new Question(R.string.i2, "True"),
            new Question(R.string.j2, "Biometric authentication factors"),
    ...
    {
        String answerIsTrue = questionBank[currentQuestionIndex]
                .isAnswerTrue();
